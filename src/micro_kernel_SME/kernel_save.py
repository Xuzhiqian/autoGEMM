...
def kernel_save_c_base_val(lable, num, mvl, nvl, pc, c0 = "za0", c1 = "za1", c2 = "za2", c3 = "za3"):
    ...
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pc, c0, c1, c2, c3, "w12", "#0", "p1", "p2", "z0", "z1", "z2", "z3", "z25", "z26")
...
def kernel_save_c_base_n_1VL_(mvl, c0 = "za0", c1 = "za1", c2 = "za2", c3 = "za3"):
    code_str = f""
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC0, c0, c1, c2, c3, "w12", "#0", "p1", "p2", "z0", "z1", "z2", "z3", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC1, c0, c1, c2, c3, "w12", "#1", "p1", "p2", "z4", "z5", "z6", "z7", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC2, c0, c1, c2, c3, "w12", "#2", "p1", "p2", "z8", "z9", "z10", "z11", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC3, c0, c1, c2, c3, "w12", "#3", "p1", "p2", "z12", "z13", "z14", "z15", "z25", "z26")

    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC0, c0, c1, c2, c3, "w13", "#0", "p1", "p2", "z0", "z1", "z2", "z3", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC1, c0, c1, c2, c3, "w13", "#1", "p1", "p2", "z4", "z5", "z6", "z7", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC2, c0, c1, c2, c3, "w13", "#2", "p1", "p2", "z8", "z9", "z10", "z11", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC3, c0, c1, c2, c3, "w13", "#3", "p1", "p2", "z12", "z13", "z14", "z15", "z25", "z26")

    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC0, c0, c1, c2, c3, "w14", "#0", "p1", "p2", "z0", "z1", "z2", "z3", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC1, c0, c1, c2, c3, "w14", "#1", "p1", "p2", "z4", "z5", "z6", "z7", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC2, c0, c1, c2, c3, "w14", "#2", "p1", "p2", "z8", "z9", "z10", "z11", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC3, c0, c1, c2, c3, "w14", "#3", "p1", "p2", "z12", "z13", "z14", "z15", "z25", "z26")

    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC0, c0, c1, c2, c3, "w15", "#0", "p1", "p2", "z0", "z1", "z2", "z3", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC1, c0, c1, c2, c3, "w15", "#1", "p1", "p2", "z4", "z5", "z6", "z7", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC2, c0, c1, c2, c3, "w15", "#2", "p1", "p2", "z8", "z9", "z10", "z11", "z25", "z26")
    code_str += save_zacol_map[f"save_zacol_{mvl}"](pC3, c0, c1, c2, c3, "w15", "#3", "p1", "p2", "z12", "z13", "z14", "z15", "z25", "z26")
