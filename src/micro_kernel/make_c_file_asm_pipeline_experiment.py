...
c_file_asm_cpp_path = os.path.join(current_directory, f'../../test/micro_kernel_tester/c_file_asm.cpp')
f = open(c_file_asm_cpp_path,'w')
logger.debug(f"Calling gemm_MxNxK_impl(M={M}, N={N}, K={K}，lda={lda}，ldb={ldb}，ldc={ldc})")
...
makefile_path = os.path.join(current_directory, f'../../test/micro_kernel_tester/Makefile')
